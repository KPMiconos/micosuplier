...
$(document).ready(function(){
	...
	$.getJSON(url,function(data){
		...
		+"<td>"+post.jumlah+"</td>"
		+"<td>"
		+"<form method='POST'"+ "action='<?php echo base_url() ?>penjualan/addCart'>"
		+"<div class='btn-group'>"
			 ...
			 <section class="col-lg-4 connectedSortable">
				...
				<div class="box">
					...
					<H3></H3>
					 ...
					 <div class="box-body">
					  <form method="post" action="<?php echo base_url() ?>penjualan/addDataBelanja">
					 <table class="table table-hover">
                    <tr>
                      ...
                      <input type="hidden" name="idtransaksi" value="<?php echo "SO",time()  ?>">
                    </tr>
					...
					<tr>
						...
						<td>
							<a href="<?php echo base_url(),"penjualan/hapus/" ,$item['rowid']; ?>">Hapus</a>
						</td>
						<?php } ?>
					</tr>
					 <tr>
					...
					<div class="form-group">
						...
						<select name="id_customer" class="form-control selecttree" style="width: 100%;" required>
