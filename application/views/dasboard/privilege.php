				 ...
				 <?php if($this->session->flashdata('pesan')){
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
					  ...
					  <td> 
					  <div>
					  <form method="post" action="<?php echo base_url('petugas/updatePrivilege') ?>">
					  <input type="hidden" name="id_petugas" value="<?php echo $baris->id_petugas ?>" >
						</div>
					  <div class="btn-group">
					  <select name="privilege" class="form-control selecttree">
						<option disabled selected value>-Pilih</option>
						<option <?php if($baris->privilege==1){
							echo "selected";
						} ?> value="1" >Admin</option>
						<option <?php if($baris->privilege==2){
							echo "selected";
						} ?> value="2">Purchasing</option>
						<option <?php if($baris->privilege==3){
							echo "selected";
						} ?> value="3">Gudang</option>
						<option <?php if($baris->privilege==4){
							echo "selected";
						} ?> value="4">Marketing</option>
						<option <?php if($baris->privilege==5){
							echo "selected";
						} ?> value="5">Produksi</option>
					  </select>
