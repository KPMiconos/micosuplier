...
<html>
  <head>
    ...
    <title>SI-Micosuplier | Dashboard</title>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/ionicon/css/ionicons.min.css">
    <!-- Theme style -->
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/flat/blue.css">
    <!-- Morris chart -->
